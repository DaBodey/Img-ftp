...
//modified to add support for png and bmp
...
Suffix::Encoding get_encoding(const string& s) {
	...
	static SuffixMap smap[] = { { ".jpg", Suffix::jpg },
			{ ".jpeg", Suffix::jpg }, { ".gif", Suffix::gif }, { ".png",
					Suffix::png }, //added for ec
			{ "bmp", Suffix::bmp }, //added for ec
			//added due to AggieSnap instructions
			{ ".JPG", Suffix::jpg }, { "JPEG", Suffix::jpg }, { ".GIF",
					Suffix::gif }, { ".PNG", Suffix::png }, //added for ec
			{ "BMP", Suffix::bmp }, //added for ec
			};
...
Image::Image(Point xy, string s, Suffix::Encoding e) :
	...
	if (!can_open(s)) {    // can we open s?
		fn.set_label("Invalid Photo:  \"" + s + '\"');
		p = new Bad_image(300, 200);    // the "error image"
		return;
	}
